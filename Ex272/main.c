...
//Exercício 272: Contar a quantidade de nós de uma Árvore Binária
...
int main()
{
    ...
    do {
        ...
        switch(optionValue) {
            ...
            case 5:
                printf("------------------------------------------\n");
                printf("QUANTIDADE DE NÓS: %d\n", amountBinaryTreeNodes(binaryTree));//Acionando o procedimento que retorna a quantidade de nós na árvore
                printf("------------------------------------------\n");
                break;
            default:
                if(optionValue)
